...
public class ViewAnimation {
    ...
    public static void fadeIn(final View v) {
        com.material.components.ViewAnimation.fadeIn(v, null);
    }
    ...
    public static void fadeOut(final View v) {
        com.material.components.ViewAnimation.fadeOut(v, null);
    }
    ...
    public static void showScale(final View v) {
        com.material.components.ViewAnimation.showScale(v, null);
    }
