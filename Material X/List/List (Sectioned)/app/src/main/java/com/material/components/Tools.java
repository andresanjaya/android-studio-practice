...
/*import com.material.components.ActivityWebView;*/
import com.material.components.DeviceInfo;
...
public class Tools {
    ...
    public static DeviceInfo getDeviceInfo(Context context) {
        ...
        deviceInfo.device = com.material.components.Tools.getDeviceName();
        deviceInfo.os_version = com.material.components.Tools.getAndroidVersion();
        deviceInfo.app_version = com.material.components.Tools.getVersionCode(context) + " (" + com.material.components.Tools.getVersionNamePlain(context) + ")";
        deviceInfo.serial = com.material.components.Tools.getDeviceID(context);
        return deviceInfo;
    }
