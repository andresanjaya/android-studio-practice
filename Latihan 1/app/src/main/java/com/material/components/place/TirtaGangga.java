...
public class TirtaGangga extends AppCompatActivity {
    ...
    private static int[] array_image_place = {
            R.drawable.tirtagangga,
            R.drawable.tirtagangga2,
            R.drawable.tirtagangga3,
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tirta_gangga);
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Tirta Gangga");
    ...
    private void initComponent() {
        ...
        ((TextView) findViewById(R.id.TV_tirtagangga)).setText(items.get(0).name);
        ((TextView) findViewById(R.id.TV_deskripsi_tirtagangga)).setText(items.get(0).brief);
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int pos) {
                ((TextView) findViewById(R.id.TV_tirtagangga)).setText(items.get(pos).name);
                ((TextView) findViewById(R.id.TV_deskripsi_tirtagangga)).setText(items.get(pos).brief);
