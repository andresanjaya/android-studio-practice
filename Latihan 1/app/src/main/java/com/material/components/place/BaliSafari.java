package com.material.components.place;
...
import com.material.components.Image;
...
public class BaliSafari extends AppCompatActivity {
    ...
    private static int[] array_image_place = {
            R.drawable.balisafari1,
            R.drawable.balisafari2,
            R.drawable.balisafari3,
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bali_safari);
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Bali Safari And Marine Park");
    ...
    private void initComponent() {
        ...
        ((TextView) findViewById(R.id.TV_bali_safari)).setText(items.get(0).name);
        ((TextView) findViewById(R.id.TV_deskripsi_bali_safari)).setText(items.get(0).brief);
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int pos) {
                ((TextView) findViewById(R.id.TV_bali_safari)).setText(items.get(pos).name);
                ((TextView) findViewById(R.id.TV_deskripsi_bali_safari)).setText(items.get(pos).brief);
