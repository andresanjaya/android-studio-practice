...
public class Batur extends AppCompatActivity {
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Batur Mount");
    ...
    private void initComponent() {
        ...
        ((TextView) findViewById(R.id.TV_batur)).setText(items.get(0).name);
        ((TextView) findViewById(R.id.TV_deskripsi_batur)).setText(items.get(0).brief);
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int pos) {
                ((TextView) findViewById(R.id.TV_batur)).setText(items.get(pos).name);
                ((TextView) findViewById(R.id.TV_deskripsi_batur)).setText(items.get(pos).brief);
