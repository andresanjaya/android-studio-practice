...
public class SanurBeach extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sanur_beach);
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Sanur Beach");
    ...
    private void initComponent() {
        ...
        ((TextView) findViewById(R.id.TV_sanur_beach)).setText(items.get(0).name);
        ((TextView) findViewById(R.id.TV_deskripsi_sanur_beach)).setText(items.get(0).brief);
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int pos) {
                ((TextView) findViewById(R.id.TV_sanur_beach)).setText(items.get(pos).name);
                ((TextView) findViewById(R.id.TV_deskripsi_sanur_beach)).setText(items.get(pos).brief);
