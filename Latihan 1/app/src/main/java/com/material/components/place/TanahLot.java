...
public class TanahLot extends AppCompatActivity {
    ...
    private static int[] array_image_place = {
            R.drawable.tanahlot2,
            R.drawable.tanahlot3,
            R.drawable.tanahlot4,
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tanahlot);
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Tanah Lot");
    ...
    private void initComponent() {
        ...
        ((TextView) findViewById(R.id.TV_tanahlot)).setText(items.get(0).name);
        ((TextView) findViewById(R.id.TV_deskripsi_tanahlot)).setText(items.get(0).brief);
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int pos) {
                ((TextView) findViewById(R.id.TV_tanahlot)).setText(items.get(pos).name);
                ((TextView) findViewById(R.id.TV_deskripsi_tanahlot)).setText(items.get(pos).brief);
