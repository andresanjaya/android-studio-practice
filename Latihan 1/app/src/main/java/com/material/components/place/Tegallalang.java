...
public class Tegallalang extends AppCompatActivity {
    ...
    private static int[] array_image_place = {
            ...
            R.drawable.tegalalang2,
            R.drawable.tegallalang3,
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tegallalang);
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Tegallalang Rice Terrace");
    ...
    private void initComponent() {
        ...
        ((TextView) findViewById(R.id.TV_tegallalang)).setText(items.get(0).name);
        ((TextView) findViewById(R.id.TV_deskripsi_tegallalang)).setText(items.get(0).brief);
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int pos) {
                ((TextView) findViewById(R.id.TV_tegallalang)).setText(items.get(pos).name);
                ((TextView) findViewById(R.id.TV_deskripsi_tegallalang)).setText(items.get(pos).brief);
